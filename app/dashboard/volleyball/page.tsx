...
const VolleyballDashboard: React.FC = () => {
  ...
  useEffect(() => {
    setPlayers([
      { id: '1', name: 'John Setter', team: 'Bong Setters', county: 'Bong', position: 'Setter', status: 'verified', registrationDate: '2025-01-10', licenseNumber: 'VOLL-001' },
      { id: '2', name: 'Mike Spiker', team: 'Lofa Spikers', county: 'Lofa', position: 'Outside Hitter', status: 'pending', registrationDate: '2025-01-12', licenseNumber: 'VOLL-002' },
      { id: '3', name: 'Sarah Blocker', team: 'Montserrado Blockers', county: 'Montserrado', position: 'Middle Blocker', status: 'verified', registrationDate: '2025-01-08', licenseNumber: 'VOLL-003' },
      { id: '4', name: 'David Libero', team: 'Nimba Liberos', county: 'Nimba', position: 'Libero', status: 'rejected', registrationDate: '2025-01-15', licenseNumber: 'VOLL-004' },
      { id: '5', name: 'Lisa Server', team: 'Grand Bassa Servers', county: 'Grand Bassa', position: 'Opposite Hitter', status: 'pending', registrationDate: '2025-01-11', licenseNumber: 'VOLL-005' }
    ]);

    setComments([
      { id: '1', playerId: '2', playerName: 'Mike Spiker', comment: 'Height verification needed - listed height seems incorrect', status: 'pending', submittedDate: '2025-01-15' },
      { id: '2', playerId: '4', playerName: 'David Libero', comment: 'Medical clearance required for knee injury', status: 'rejected', reason: 'Insufficient medical documentation', submittedDate: '2025-01-14' },
      { id: '3', playerId: '5', playerName: 'Lisa Server', comment: 'Age verification needed - birth certificate unclear', status: 'pending', submittedDate: '2025-01-13' }
    ]);
  }, []);
  ...
  const renderPlayerVerification = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gray-900">Volleyball Player Verification</h3>
        <div className="text-sm text-gray-600">
          Discipline: <span className="font-semibold text-indigo-600">Volleyball</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="Bong Setters">Bong Setters</option>
              <option value="Lofa Spikers">Lofa Spikers</option>
              <option value="Montserrado Blockers">Montserrado Blockers</option>
              <option value="Nimba Liberos">Nimba Liberos</option>
              <option value="Grand Bassa Servers">Grand Bassa Servers</option>
            </select>
          </div>
          <div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        className="w-32 px-2 py-1 text-xs border border-gray-300 rounded focus:ring-indigo-500 focus:border-indigo-500"
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="flex">
        ...
        <div className="w-64 bg-white shadow-sm min-h-screen">
          <div className="p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Volleyball Dashboard</h2>
            <p className="text-sm text-gray-600 mb-4">Volleyball Federation</p>
            <nav className="space-y-2">
              ...
              <button
                ...
                className={`w-full flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                  activeTab === 'players' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-600 hover:bg-gray-100'
                }`}
              >
              ...
              <button
                ...
                className={`w-full flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                  activeTab === 'comments' ? 'bg-indigo-100 text-indigo-700' : 'text-gray-600 hover:bg-gray-100'
                }`}
              >
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                {activeTab === 'players' ? 'Volleyball Player Verification' : 
              ...
              <p className="text-gray-600 mt-1">
                {activeTab === 'players' ? 'Verify players and submit comments for backend approval' :
                 ...
                 'Volleyball Federation Dashboard Overview'}
              </p>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">Role: Volleyball Federation Official</span>
              <button
                onClick={() => router.push('/')}
