...
const BasketballDashboard: React.FC = () => {
  ...
  useEffect(() => {
    setPlayers([
      { id: '1', name: 'John Point Guard', team: 'Bong Hoops', county: 'Bong', position: 'Point Guard', status: 'verified', registrationDate: '2025-01-10', licenseNumber: 'BASK-001' },
      { id: '2', name: 'Mike Shooting Guard', team: 'Lofa Dunkers', county: 'Lofa', position: 'Shooting Guard', status: 'pending', registrationDate: '2025-01-12', licenseNumber: 'BASK-002' },
      { id: '3', name: 'Sarah Power Forward', team: 'Montserrado Stars', county: 'Montserrado', position: 'Power Forward', status: 'verified', registrationDate: '2025-01-08', licenseNumber: 'BASK-003' },
      { id: '4', name: 'David Center', team: 'Nimba Giants', county: 'Nimba', position: 'Center', status: 'rejected', registrationDate: '2025-01-15', licenseNumber: 'BASK-004' },
      { id: '5', name: 'Lisa Small Forward', team: 'Grand Bassa Ballers', county: 'Grand Bassa', position: 'Small Forward', status: 'pending', registrationDate: '2025-01-11', licenseNumber: 'BASK-005' }
    ]);

    setComments([
      { id: '1', playerId: '2', playerName: 'Mike Shooting Guard', comment: 'Height verification needed - listed height seems incorrect', status: 'pending', submittedDate: '2025-01-15' },
      { id: '2', playerId: '4', playerName: 'David Center', comment: 'Medical clearance required for previous injury', status: 'rejected', reason: 'Insufficient medical documentation', submittedDate: '2025-01-14' },
      { id: '3', playerId: '5', playerName: 'Lisa Small Forward', comment: 'Age verification needed - birth certificate unclear', status: 'pending', submittedDate: '2025-01-13' }
    ]);
  }, []);
  ...
  const renderPlayerVerification = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gray-900">Basketball Player Verification</h3>
        <div className="text-sm text-gray-600">
          Discipline: <span className="font-semibold text-orange-600">Basketball</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="Bong Hoops">Bong Hoops</option>
              <option value="Lofa Dunkers">Lofa Dunkers</option>
              <option value="Montserrado Stars">Montserrado Stars</option>
              <option value="Nimba Giants">Nimba Giants</option>
              <option value="Grand Bassa Ballers">Grand Bassa Ballers</option>
            </select>
          </div>
          <div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        className="w-32 px-2 py-1 text-xs border border-gray-300 rounded focus:ring-orange-500 focus:border-orange-500"
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="flex">
        ...
        <div className="w-64 bg-white shadow-sm min-h-screen">
          <div className="p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-6">Basketball Dashboard</h2>
            <p className="text-sm text-gray-600 mb-4">Basketball Federation</p>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                {activeTab === 'players' ? 'Basketball Player Verification' : 
              ...
              <p className="text-gray-600 mt-1">
                {activeTab === 'players' ? 'Verify players and submit comments for backend approval' :
                 ...
                 'Basketball Federation Dashboard Overview'}
              </p>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">Role: Basketball Federation Official</span>
              <button
                onClick={() => router.push('/')}
