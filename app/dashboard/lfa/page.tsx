...
const LFADashboard: React.FC = () => {
  ...
  useEffect(() => {
    setPlayers([
      { id: '1', name: 'James Player', team: 'Bong United', county: 'Bong', position: 'Forward', status: 'verified', registrationDate: '2025-01-10', licenseNumber: 'LFA-001' },
      { id: '2', name: 'David Striker', team: 'Lofa Warriors', county: 'Lofa', position: 'Midfielder', status: 'pending', registrationDate: '2025-01-12', licenseNumber: 'LFA-002' },
      { id: '3', name: 'Emma Defender', team: 'Montserrado Stars', county: 'Montserrado', position: 'Defender', status: 'verified', registrationDate: '2025-01-08', licenseNumber: 'LFA-003' },
      { id: '4', name: 'Sarah Runner', team: 'Nimba United', county: 'Nimba', position: 'Forward', status: 'rejected', registrationDate: '2025-01-15', licenseNumber: 'LFA-004' },
      { id: '5', name: 'Mike Jumper', team: 'Grand Bassa FC', county: 'Grand Bassa', position: 'Goalkeeper', status: 'pending', registrationDate: '2025-01-11', licenseNumber: 'LFA-005' }
    ]);

    setComments([
      { id: '1', playerId: '2', playerName: 'David Striker', comment: 'Player eligibility needs verification - age documentation unclear', status: 'pending', submittedDate: '2025-01-15' },
      { id: '2', playerId: '4', playerName: 'Sarah Runner', comment: 'Medical clearance required before approval', status: 'rejected', reason: 'Insufficient medical documentation', submittedDate: '2025-01-14' },
      { id: '3', playerId: '5', playerName: 'Mike Jumper', comment: 'Transfer documentation incomplete', status: 'pending', submittedDate: '2025-01-13' }
    ]);
  }, []);
  ...
  const renderPlayerVerification = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gray-900">Football Player Verification</h3>
        <div className="text-sm text-gray-600">
          Discipline: <span className="font-semibold text-blue-600">Football</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="Bong United">Bong United</option>
              <option value="Lofa Warriors">Lofa Warriors</option>
              <option value="Montserrado Stars">Montserrado Stars</option>
              <option value="Nimba United">Nimba United</option>
              <option value="Grand Bassa FC">Grand Bassa FC</option>
            </select>
          </div>
          <div>
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="flex">
        ...
        <div className="w-64 bg-white shadow-sm min-h-screen">
          <div className="p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-6">LFA Dashboard</h2>
            <p className="text-sm text-gray-600 mb-4">Football Federation</p>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                {activeTab === 'players' ? 'Football Player Verification' : 
              ...
              <p className="text-gray-600 mt-1">
                {activeTab === 'players' ? 'Verify players and submit comments for backend approval' :
                 ...
                 'LFA Football Federation Dashboard Overview'}
              </p>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">Role: LFA Football Official</span>
              <button
                onClick={() => router.push('/')}
